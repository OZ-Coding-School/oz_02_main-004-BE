...
class KakaoView(APIView):
    def get(self, request):
        ...
        redirect_uri = 'http://3.39.0.250:8000/users/kakao/callback'
...
class KakaoCallBackView(APIView):
    def get(self, request):
        data = {
            ...
            'client_id' : '92ec542f65f17550dbc2fbf553c44822',
            'redirection_uri' : 'http://3.39.0.250:8000/users/kakao/',
        ...
        if email:
            ...
            response = HttpResponseRedirect('http://3.39.0.250:8000/users/myinfo') # 로그인 완료 시 리디렉션할 URL
