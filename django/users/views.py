...
class UserDetailView(APIView):
    ...
    def get(self, request, pk):
        ...
        user_data = {
            'id' : user.id, '계정' : user.email, '닉네임' : user.nickname, '운영진' : user.is_staff,
            '휴면회원' : user.is_down, '활동회원': user.is_active,
...
class KakaoView(APIView):
    def get(self, request):
        ...
        redirect_uri = 'https://oz-02-main-04.xyz/api/v1/users/kakao/callback'
...
class KakaoCallBackView(APIView):
    def get(self, request):
        data = {
            ...
            'client_id' : '92ec542f65f17550dbc2fbf553c44822',
            'redirection_uri' : 'https://oz-02-main-04.xyz/api/v1/users/kakao/',
        ...
        if email:
            ...
            response = HttpResponseRedirect('https://oz-02-main-04.xyz/api/v1/users/myinfo') # 로그인 완료 시 리디렉션할 URL
