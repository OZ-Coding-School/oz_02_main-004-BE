...
urlpatterns = [
    ...
    path(
        "closet/select-pet/", SelectPrimaryPetView.as_view(), name="select-primary-pet"
    ),
    path(
        "closet/select-accessory/",
        SelectPrimaryAccessoryView.as_view(),
        name="select-primary-accessory",
    ),
    path(
        "closet/select-background/",
        SelectPrimaryBackgroundView.as_view(),
        name="select-primary-background",
    ),
    path(
        "closet/accessories/",
        ClosetAccessoriesView.as_view(),
        name="closet-accessories",
    ),
    path(
        "closet/backgrounds/",
        ClosetBackgroundsView.as_view(),
