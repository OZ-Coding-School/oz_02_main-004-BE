...
from posts.serializer import (
    ...
    TimerSerializer, TimerCreateSerializer, TimerActionSerializer, ToDoSerializer, ToDoEditSerializer, ToDoCreateSerializer,
    ConsecutiveDaysSerializer, UserGoalSerializer,
)
        ...
        try:
            ...
            for track in results['tracks']['items']:
                track_data = {
                    ...
                    'title': track['name'],
                    'song_url': track['preview_url'],  # spotify에서 불러올때 None 값이 존재함
                    'post': post.id,
                }
